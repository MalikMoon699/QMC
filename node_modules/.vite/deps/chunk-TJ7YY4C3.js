...
var Typography = React30.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? Typography.propTypes = {
   ...
   */
  color: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]), import_prop_types19.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var SvgIcon = React37.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React37.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
  ...
  return (0, import_jsx_runtime23.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime23.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime24.jsx)(SvgIcon_default, {
...
function useControlled(props) {
  ...
  } = React39.useRef(controlled !== void 0);
  const [valueState, setValue] = React39.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React39.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
var elementTypeAcceptingRef_default = chainPropTypes(import_prop_types26.default.elementType, elementTypeAcceptingRef);
...
function useLazyRef(init, initArg) {
  const ref = React41.useRef(UNINITIALIZED);
...
var TouchRipple = React51.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const start2 = React51.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TJ7YY4C3.js.map
