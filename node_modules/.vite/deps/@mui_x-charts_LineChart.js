...
import {
  ...
  useTheme,
  useThemeProps
} from "./chunk-TJ7YY4C3.js";
import "./chunk-BAXSPHD3.js";
import {
  clsx_default
...
var reactMajor_default = parseInt(React56.version, 10);
...
var useLineChartProps = (props) => {
  ...
  const seriesWithDefault = React65.useMemo(() => series.map((s) => _extends({
